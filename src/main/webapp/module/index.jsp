	...
	<center>
		...
		<table width="778" border="0" cellPadding="0" cellSpacing="1"
			...
			<tr bgcolor="#EFF3F7" class="TableBody1">
				...
				<td width="23" height="37" align="center"><B>模块名称</B></td>
				<td width="18%" height="37" align="center"><b>模块编号</b></td>
				<td width="18%" height="37" align="center"><b>父模块名称</b></td>
				<td width="30%" height="37" align="center"><b>模块地址</b></td>
				<td width="18%" height="37" align="center"><b>序号</b></td>
				<td width="5%" height="37" align="center"><b>相关操作</b></td>
			</tr>
			<!-- 列表数据栏 -->
			<c:if test="${!empty pm.dataList}">
				<c:forEach items="${pm.dataList }" var="mudule">
					<tr bgcolor="#EFF3F7" class="TableBody1"
						onmouseover="this.bgColor = '#DEE7FF';"
						onmouseout="this.bgColor='#EFF3F7';">
						<td align="center" vAlign="center">${mudule.id }</td>
						<td align="center" vAlign="center"><a
							href="module/findAll.action?pid=${mudule.id }">${mudule.name }</a></td>
						<td align="center" vAlign="center">${mudule.sn }</td>
