...
<table class="tableEdit" style="width:580px;" cellspacing="0" border="0" cellpadding="0">
	<tr>
		...
		onclick="openWin('${pageContext.request.contextPath}/person/findAllOrg.action?pid=0','selectparties',800,600,1);">
		</td>
	...
	<tr>
		...
		<td class="tdEditContent" colspan="3"><input type="text" name="duty">
		</td>
	</tr>
</table>
